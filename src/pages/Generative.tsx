...
import geneheropic from '../assets/images/course9.png'
import generalai from '../assets/images/generalAI.png'
...
const Aimachine = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        saveSubmission('generative', payload)
        form.reset()
    }
  ...
  return (
    <section className='w-full bg-white'>
              ...
              <div className='flex flex-col md:flex-row gap-10 items-center justify-between md:px-40 px-6 my-'>
                    ...
                    <div className='flex flex-col md:max-w-[800px]'>
                        <div className='md:max-w-[550px] '>
                            <h1 className='md:text-[50px] text-[26px] font-[700] text-[#301D20] [font-family:Playfair_Display,serif] leading-tight md:leading-[1.05] tracking-tight md:max-w-[550px] max-w-full break-words text-left'>Generative AI For Professionals</h1>
                        </div>
                        <div className='md:max-w-[700px] flex flex-col gap-3 mt-5'>
                                 <h2 className='md:text-[50px] text-3xl font-[650] text-[#6c0c11]'>300,000 NGN </h2>
                                  <p className='font-[500] md:text-[16px] text-[14px] text-[#301D20]'>Empower Your Career with the Intelligence of Tomorrow.</p>
                                  <div className='md:max-w-[600px] '>
                                    <p className='font-[390] md:text-[16px] text-[14px] text-[#7F676B]'>Master the tools, strategies, and mindset to integrate Artificial Intelligence into your work — transforming how you think, create, and make decisions.</p>
                                  </div>
                    ...
                    {/* Right side */}
                    <div className='md:max-w-[600px] '>
                        <img src={geneheropic} alt="Digital Growth" className='md:w-full md:h-115 h-70 w-auto object-cover rounded-lg' />
                    </div>
              </div>
        </div>
      </section>
      ...
      <section className='bg-white w-full font-poppins'>
          {/* Course Overview */}
          <div className='mt-10 bg-gradient-to-r from-[#AE6AF8] to-[#EBADF1]'>
             <div className='md:max-w-4xl mx-auto md:px-0 px-6 py-10 md:py-25'>
                <div className='flex flex-col gap-8 items-center justify-center'>
                <h2 className='md:text-[40px] font-[600] text-[20px] md:text-center text-white [font-family:Playfair_Display,serif]'>Advance Your Professional Edge with AI</h2>
                <div className='flex flex-col gap-5 items-center '>
                    <p className='md:text-[16px] text-[13px] md:text-center  text-white'>Artificial Intelligence isn’t the future — it’s the present. This immersive program is designed for <span className='font-[405]'>professionals, business leaders, and entrepreneurs</span>  who want to stay ahead in a world shaped by automation, data, and intelligent system</p>
                    <p className='md:text-[16px] text-[13px] md:text-center  text-white'>Whether you’re in<span className='font-[405]'>business, design, marketing, management, or tech</span> , you’ll learn how to apply AI practically to boost productivity, optimize workflows, and unlock innovation.</p>
          ...
          <section className='mt-10 bg-black text-white font-poppins'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-15 md:py-25'>
                    <div className='flex md:flex-row flex-col gap-10'>
                        {/* Left Side */}
                        <div className='md:max-w-[650px]'>
                            <div className='flex flex-col gap-5'>
                                <h2 className='md:text-[40px] text-[20px] font-[550] md:max-w-[500px]'>Transform How You Work with AI</h2>
                                <div className='flex md:flex-row flex-col gap-3 '>
                                 <p className='font-[400] md:text-[16px] text-[14px]'>Learn to work smarter, not harder — by integrating AI into everyday professional life. From automating reports to generating insights, you’ll discover how AI enhances decision-making, speeds up processes, and amplifies creativity.</p>
                                 
                                </div>
                                <p className='font-[425] md:text-[16px] text-[14px]'>You’ll master AI tools such as:</p>
                                ...
                                <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>ChatGPT & Claude:</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>for research, brainstorming, and automation</p>
                                   </div>
                                   {/* 2nd */}
                                   <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                    ...
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>for creative ideation and visual storytelling</p>
                                   </div>
                                   {/* 3rd */}
                                   <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Notion AI & Excel Copilot:</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>for workflow and data efficiency</p>
                                   </div>
                                      {/* 4th */}
                                      <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Google Gemini & Power BI AI:</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>for smarter analytics and reporting</p>
                                   </div>
                                ...
                                <div className='flex flex-col gap-3'>
                                    <p className='font-[390] md:text-[16px] text-[13px]'>Walk away with real projects and strategies that make you an AI-powered innovator in your field.</p>
                        ...
                        {/* Right Side */}
                        <div className='md:max-w-[600px]'>
                            <img src={generalai} alt='image' className='w-full md:h-105 h-70 object-cover rounded-lg border-5 border-white md:mt-25' />
                        </div>
                    </div>
                </div>
          </section>
          ...
          <section className='md:mt-15 mt-10 font-poppins bg-white'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-0 mb-10'>
                      <div className='flex flex-col gap-3 items-center justify-center md:max-w-3xl mx-auto text-center mb-12'>
                        ...
                        <p className='font-[395] md:text-[16px] text-[14px] text-[#926470]'>In this transformative 12-week experience, you’ll gain the technical fluency and creative confidence to 
                                                     harness AI in your professional domain.</p>
                      </div>
                     ...
                     <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2.5'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>AI Foundations for Professionals</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand the key concepts behind Artificial Intelligence and Machine Learning.</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn how AI impacts industries and decision-making.</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Master the language of AI to communicate confidently with tech teams</li>
                            </div>
                        </div>
                        {/* 2nd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Applied AI for Business & Productivity</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]' >Automate repetitive tasks using smart AI workflows.</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Integrate AI tools to streamline documentation, content creation, and data analysis</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn prompt engineering techniques to get high-quality outputs every time</li>
                            </div>
                        </div>
                        {/* 3rd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Data-Driven Decision Making</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Turn raw data into insights using AI-assisted analytics tools.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Explore real business use cases — from marketing and finance to HR and strategy.</li>
                                 <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn to evaluate AI solutions ethically and effectively.</li>
                            </div>
                        </div>
                        {/* 4th */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Creative Intelligence</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Use AI tools to enhance ideation, storytelling, and presentation design.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Explore the power of generative AI for content, images, and innovation.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Develop an AI-augmented workflow that supports creativity and strategy.</li>
                            </div>
                        </div>
                        {/* 5th */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Real-World Projects & Mentorship</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Complete hands-on projects that simulate workplace challenges.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Receive feedback from mentors who are experts in AI transformation.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Build a mini portfolio or case study to showcase your professional growth. </li>
                            </div>
                        </div>
                     </div>
          ...
          <section className='md:max-w-6xl mx-auto md:px-0 px-6 pt-5 md:pt-10 mb-10 font-poppins'>
                    <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='bg-[#EFE1DD] text-[#942E3F] md:py-3 py-2.5 md:px-14 px-5 rounded-xl font-poppins md:text-[15px] text-[14px]'>Brochure</h2>
                    </div>

                        {/* why choose */}
                        <div className=' bg-[#8F2436] text-white font-poppins mt-10  rounded-xl'>
                    ...
                    {/* 2nd */}
                     <div className='flex flex-row gap-3 items-center'>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Industry-Relevant Learning:<span className='font-[395]'>Real tools. Real applications. Real results.</span></p>
                    </div>
                    {/* 3rd */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Mentorship-Driven:<span className='font-[395]'>Learn directly from AI practitioners and business experts</span></p>
                    </div>
                    {/* 4th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Flexible Learning:<span className='font-[395]'> Choose between online and in-person sessions at your pace.</span></p>
                    </div>
                    {/* 5th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Future-Ready Curriculum:<span className='font-[395]'> Stay ahead in a fast-evolving AI-powered world.</span></p>
                    </div>
                </div>
      ...
      {/* Location Section */}
       <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-[#8F2436] text-white md:rounded-lg'>
        <div className='md:p-20  p-6 '>
         ...
         {/*input form section */}
             ...
             <section ref={formRef} className='md:max-w-7xl mx-auto md:mt-20 mt-10 md:px-0 px-8 font-poppins'>
                     <div className=' text-center'>
                            <h2 className='md:text-2xl text-[20px] font-[500]'>Fill out the form below to receive the program that you're interested in.</h2>
                     </div>
                     {/* Form fields */}
                    <form onSubmit={handleSubmit} className='flex flex-col md:gap-5 gap-5 mt-10 md:mb-20 mb-10  md:max-w-[500px] mx-auto'>
                      <input type='hidden' name='course' value='Generative AI' />
                         ...
                         <div className='flex flex-col gap-2'>
                            ...
                            <select name='source' className='border border-gray-300 text-[#958184] p-2 rounded-md text-sm font-[380] focus:outline-none focus:ring focus:ring-gray-300'>
                         ...
                         <div className='flex flex-col gap-2'>
                            ...
                            <select name='hybrid' className='border border-gray-300 text-[#958184] p-2 font-[380] rounded-md text-sm focus:outline-none focus:ring focus:ring-gray-300'>
                                <option value=''>Select an option</option>
         ...
         {/* Best Instructors */}
            <section className='md:max-w-6xl mx-auto mt-10 mb-20 bg-gradient-to-r from-[#AE6AF8] to-[#EBADF1] md:rounded-2xl font-poppins' >
