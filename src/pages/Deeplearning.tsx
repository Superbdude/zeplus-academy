...
import cybtheropic from '../assets/images/course11.png'
...
const Deeplearning = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      ...
      saveSubmission('deeplearning', payload)
      form.reset()
    }
  ...
  return (
    <section className='w-full bg-white'>
      ...
      >
        <div className='md:py-45 py-7 md:max-w-8xl mx-auto'>
              <div className='flex flex-col md:flex-row gap-10 items-center justify-between md:px-40 px-6 '>
                    ...
                    <div className='flex flex-col md:max-w-[800px]'>
                        <div className='md:max-w-[600px] '>
                            <h1 className='md:text-[50px] text-[26px] font-[700]  text-[#301D20] [font-family:Playfair_Display,serif] leading-tight md:leading-[1.05] tracking-tight md:max-w-[600px] max-w-full break-words text-left'>Deep Learning</h1>
                        </div>
                        <div className='md:max-w-[700px] flex flex-col gap-3 mt-5'>
                                 ...
                                 <div className='flex flex-row gap-4'>
                                    <p className='font-[405] text-[14px] md:text-[16px] text-[#301D20]'>Advance Beyond AI — Master the Core of Machine Intelligence</p>
                                     
                                 </div>
                                  <div className='md:max-w-[600px] '>
                                    <p className='font-[390] md:text-[16px] text-[14px] text-[#7F676B]'>Unlock the power of neural networks and discover how machines learn, adapt, and think. This course takes you deep into the architecture of intelligence — where innovation meets data, and ideas become smarter solutions.</p>
                                  </div>
                                  ...
                                  <div className='md:max-w-[650px] mt-4'>
                                    ...
                                    <div className='flex flex-row gap-3'>
                                        ...
                                        <p className='font-[395] md:text-[15px] text-[13px] text-[#301D20]'><span className='font-[600]'>Duration:</span> 13 weeks</p>
                                    </div>
                                    {/* 2nd */}
                                    <div className='flex flex-row gap-3'>
                                        <span>
      ...
      <section className='bg-white w-full font-poppins'>
          ...
          <div className=' bg-[#F9F6F0]'>
             <div className='md:max-w-5xl mx-auto md:px-0 px-6 py-10 md:py-25'>
                <div className='flex flex-col gap-8 items-center justify-center'>
                <h2 className='md:text-[35px] font-[700] text-[20px] md:text-center text-[#301D20] [font-family:Playfair_Display,serif]'>Become a Certified Deep Learning Specialist in 13 Weeks</h2>
                
                    <p className='md:text-[16px] text-[13px] md:text-center  text-[#958184]'>Turn your passion for AI into expertise. Learn to build intelligent models that power computer vision, speech recognition, and generative AI tools across industries. Gain hands-on experience designing, training, and deploying deep learning systems — ready for real-world impact.</p>                
                <div className='bg-[#ffffff] px-10 pb-15 pt-10 flex flex-col gap-5 rounded-lg'>
                    <h2 className='md:text-[24px] text-[18px] font-[600] flex items-center justify-center text-[#301D20]'>Why Deep Learning?</h2>
                    <div className='flex flex-col gap-3'>
                    <div className='flex flex-row gap-3 items-center'>
                   <span>
                    <img src={mark} alt='icon' className='w-5 h-5 '/>
                   </span>
                     <p className='font-[395] md:text-[15px] text-[13px] text-[#958184]'>Deep learning is the driving force behind the most powerful AI systems — from ChatGPT and self driving cars to medical imaging and facial recognition.</p>
                    </div>
                    {/* 2nd */}
                    <div className='flex flex-row gap-3 items-center'>
                   <span>
                    <img src={mark} alt='icon' className='w-4 h-4 '/>
                   </span>
                     <p className='font-[395] md:text-[15px] text-[13px] text-[#958184]'>This course helps you go beyond surface-level AI to truly understand how machines make intelligent decisions.</p>
                    </div>
                    {/* 3rd */}
                     <div className='flex flex-row gap-3 items-center'>
                   <span>
                    <img src={mark} alt='icon' className='w-7 h-7 '/>
                   </span>
                     <p className='font-[395] md:text-[15px] text-[13px] text-[#958184]'>Designed for aspiring AI professionals, data scientists, and engineers, this program equips you with the technical confidence and creative problem-solving skills needed to lead in the age of intelligent automation.</p>
                    </div>
                </div>
          ...
          <section className='md:mt-15 mt-10 font-poppins bg-white'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-0 md:mb-10'>
                      <div className='flex flex-col gap-3 items-center justify-center md:max-w-3xl mx-auto text-center md:mb-12 mb-10'>
                        ...
                        <p className='font-[395] md:text-[16px] text-[13px] text-[#926470]'>n this immersive 13-week program, you’ll gain both the technical mastery and creative confidence to build, train, and deploy    
                                                             intelligent systems that learn and improve on their own.</p>
                      </div>
                     ...
                     <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2.5'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[16px] text-[13px]'>Deep Learning Foundations</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand the mathematics of neural networks and backpropagation.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn tensors, gradients, activation functions, and optimization algorithms.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Build a strong foundation for deep model development.</li>
                            </div>
                        </div>
                        {/* 2nd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[16px] text-[13px]'>Building Neural Architectures</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Develop and train Convolutional Neural Networks (CNNs) for image recognition.</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Create Recurrent Neural Networks (RNNs) and LSTMs for sequence data.</li>
                                 <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Explore advanced architectures like GANs and Transformers.</li>
                            </div>
                        </div>
                        {/* 3rd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[16px] text-[13px]'>AI in Action</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Apply deep learning in real-world use cases — NLP, Computer Vision, and Generative AI.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Work with real datasets to design scalable, production-ready solutions</li>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[16px] text-[13px]'>Optimization & Deployment</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn hyperparameter tuning, model evaluation, and debugging.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Deploy deep learning models using TensorFlow Serving and cloud platforms.</li>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[16px] text-[13px]'>Capstone Project & Portfolio</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Build a complete deep learning project from concept to deployment.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Showcase your model performance and innovation in your portfolio.</li>
                                
                            </div>
                        </div>
                     </div>
                   <div className='mt-20 flex items-center justify-center'>
                     <button className='bg-[#EE5B2A] text-white rounded-xl md:px-5 px-4 py-3 md:text-[15px] text-[13px] font-[400]'>Brochure</button>
                   </div>
                </div>
          </section>

          <section className='md:max-w-6xl mx-auto mt-10 font-poppins py-15 md:py-20 md:px-15 px-6 bg-[#8F2436] text-white rounded-xl'>
         ...
         <section className='md:max-w-6xl mx-auto my-10 font-poppins py-15 md:py-20 md:px-15 px-6 bg-[#8F2436] text-white rounded-xl'>
              <div className='flex flex-col gap-2 '> 
                <h2 className='md:text-[30px] text-[20px] font-[600] flex items-center justify-center'>Why Choose Zeplus Academy?</h2>
                <p className='md:text-[15px] text-[13px] font-[395]'>At Zeplus Academy, we don’t just teach tools — we empower professionals to lead change.</p>
                ...
                <div className='flex flex-col gap-2 mt-2'>
                    ...
                    {/* 2nd */}
                     <div className='flex flex-row gap-3 items-center'>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Project-Based Learning:<span className='font-[395]'>Build real projects, not just theories.</span></p>
                    </div>
                    {/* 3rd */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Mentorship-Driven:<span className='font-[395]'>Learn directly from top AI engineers and data scientists</span></p>
                    </div>
                    {/* 4th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>AI-Powered Curriculum:<span className='font-[395]'> Stay future-ready with intelligent learning tools.</span></p>
                    </div>
                    {/* 5th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Community Network:<span className='font-[395]'>Join a movement shaping Africa’s digital intelligence.</span></p>
                    </div>
                </div>
              </div>
         </section>
       ...
       <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-[#F6F7FD] rounded-lg'>
               ...
               <div className='flex flex-col gap-5 md:mt-4'>
                <div className='flex md:flex-row flex-col gap-3 md:gap-10'>
                    ...
                    <div className='flex flex-row gap-5'>
                        <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='text-white bg-[#8F2436] md:py-3 py-2.5 md:px-10 px-5 rounded font-poppins md:text-[15px] text-[13px]'>Brochure</h2>
                    </div>
                    <a href="https://wa.me/2348169669110?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20Data%20Analytics%20with%20AI%20and%20Visualization%20Tools%20course%20at%20Zeplus%20Academy."
                                         target="_blank"
                                            rel="noopener noreferrer"
         ...
         {/*input form section */}
             ...
             <div className='bg-[#8F2436] md:rounded-2xl text-white'>
                     <div className='flex flex-col md:items-center md:justify-center py-10 md:py-20 md:px-0 px-5 '>
                             <div className='md:max-w-[700px] md:text-center px-5 md:mb-10 mb-5'>
                                  <h2 className='md:text-[40px] text-[20px] font-[550]'>Want to join the Deep Learning Class?</h2>
                             </div>
                             <div className='flex flex-col md:flex-row md:gap-40 gmd:ap-5 gap-4'>
             ...
             <div className='md:max-w-[550px] mx-auto mt-10 md:mt-20 font-poppins '>
                     ...
                     <form onSubmit={handleSubmit} className='flex flex-col md:gap-5 gap-5 mt-10 md:mb-20 mb-10 px-8 md:px-0 md:max-w-[500px] mx-auto'>
                      <input type='hidden' name='course' value='Deep Learning' />
                        ...
                        <button type='submit' className='bg-[#EFE1DD] text-[#958184] py-2.5  font-[380] rounded-xl md:mb-20 mb-10 w-40 md:text-[15px] text-[14px]'>Submit</button>
                     </form>
             </div>
        </section>
