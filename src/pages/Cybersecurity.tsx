...
import cybersecurityheropic from '../assets/images/course4.jpg'
...
const Cybersecurity = () => {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>): void {
    ...
    // ensure course is set (hidden input exists but enforce here)
    if (!payload.course) payload.course = 'Introduction Cybersecurity'
    try {
      saveSubmission('cybersecurity', payload)
    } catch (err) {
  ...
  return (
    <section className='w-full bg-white'>
              ...
              <div className='flex flex-col md:flex-row gap-10 items-center justify-between md:px-40 px-6 my-'>
                    ...
                    <div className='flex flex-col md:max-w-[800px]'>
                        <div className='md:max-w-[550px] '>
                            <h1 className='md:text-[49px] text-[27px] font-[700] text-[#301D20] [font-family:Playfair_Display,serif] leading-tight md:leading-[1.05] tracking-tight md:max-w-[550px] max-w-full break-words text-left'>Cybersecurity And Ethical Hacking Course with AI Tools</h1>
                        </div>
                        <div className='md:max-w-[700px] flex flex-col gap-3 mt-5'>
                                 <h2 className='md:text-[50px] text-3xl font-[650] text-[#6c0c11]'>550,000 NGN </h2>
                                 <div className='flex flex-row gap-4'>
                                    <p className='font-[695] text-[14px] md:text-[16px] text-[#7F676B] text-[#301D20] [font-family:Playfair_Display,serif]'>Protect the Future</p>
                                     <p className='font-[695] text-[14px] md:text-[16px] text-[#7F676B] text-[#301D20] [font-family:Playfair_Display,serif]'>Defend the Digital World.</p>
                                 </div>
                                  <div className='md:max-w-[600px] '>
                                    <p className='font-[390] text-[14px] md:text-[16px] text-[#7F676B]'>Gain the skills to secure systems, prevent cyber threats, and lead Africa’s next 
                                   ...
                                   <div className='flex flex-row gap-2.5 items-center justify-center cursor-pointer bg-[#27D366] md:px-20 px-15 py-4 rounded-xl'>
                                    <p className='font-[500] text-[14px] md:text-[16px] '>Let's Talk</p>
                                    <span>
                                  ...
                                  <div className='md:max-w-[650px] mt-4'>
                                    ...
                                    <div className='flex flex-row gap-3'>
                                        ...
                                        <p className='font-[395] text-[14px] md:text-[15px] text-[#301D20]'><span className='font-[600]'>Duration:</span> 16 weeks</p>
                                    </div>
                                    {/* 2nd */}
                                    <div className='flex flex-row gap-3'>
                                        <span>
                                        ...
                                        <p className='font-[395] text-[14px] md:text-[15px] text-[#301D20]'><span className='font-[600]'>Hybrid Learning:</span> Online or in-Person</p>
                                    </div>
                                  ...
                                  <div className='flex md:flex-row flex-col md:gap-18 gap-2 md:mt-3 mt-2'>
                                    ...
                                    <div className='flex flex-row gap-3'>
                                        ...
                                        <p className='font-[600] text-[#301D20] md:text-[15px] text-[14px] '>4 hours/week</p>
                                    </div>
                                    {/* 4th */}
                                    <div className='flex flex-row gap-3'>
                                        <span>
                                        ...
                                        <p className='font-[395] text-[14px] md:text-[15px] text-[#301D20]'><span className='font-[600]'>Flexible Schedules:</span> Day or Evening Classes <br />Part time also available once a week</p>
                                    </div>
                                  </div>
                    ...
                    {/* Right side */}
                    <div className='md:max-w-[600px] '>
                        <img src={cybersecurityheropic} alt="Digital Growth" className='w-full md:h-115 h-70 object-cover rounded-lg' />
                    </div>
              </div>
        </div>
      </section>
      ...
      {/* Course Overview */}
      <section className='bg-white w-full font-poppins mt-15'>
          {/* Course Overview */}
          <div className=' bg-[#F9F6F0] md:max-w-[1350px] md:rounded-2xl mx-auto md:px-0 px-6 py-10 md:py-20'>
             <div className='md:max-w-4xl mx-auto md:px-0 px-6 '>
                <div className='flex flex-col md:gap-8 gap-3 items-center justify-center'>
                <h2 className='md:text-[40px] font-[700] text-[20px] md:text-center text-[#301D20] [font-family:Playfair_Display,serif]'>Master Cyber Defense in 16 Weeks</h2>
                <div className='flex flex-col gap-3 items-center '>
                    <p className='md:text-[16px] text-[13px] md:text-center text-[#958184]'>Learn how to identify vulnerabilities, protect networks, and detect attacks before they happen.</p>
                    <p className='md:text-[16px] text-[13px] md:text-center text-[#958184]'>Our AI-powered cybersecurity course combines hands-on labs with expert mentorship to prepare you for the real world.</p>
          ...
          <section className='mt-10 bg-[#8F2436] text-white font-poppins md:max-w-[1350px] mx-auto md:px-20 px-6 md:rounded-2xl'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-10 md:py-15'>
                    <div className='flex md:flex-row flex-col gap-10 items-center'>
                        {/* Left Side */}
                        <div className='md:max-w-[650px]'>
                            <div className='flex flex-col md:gap-5 gap-3'>
                                <h2 className='md:text-[40px] text-[20px] font-[550] text-white [font-family:Playfair_Display,serif]'>AI-Powered Cyber Defense</h2>
                                <p className='md:text-[16px] text-[13px] font-[395]'>Today’s hackers use AI — and so will you.</p>
                                <p className='font-[395] text-[13px] md:text-[16px]'>Learn how AI strengthens defense systems, predicts threats, and enhances your security analysis.</p>
                                <div className='flex flex-col gap-4 mt-3 md:ml-10'>
                                   ...
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Network Security & Firewalls</p>
                                   ...
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Penetration Testing & Ethical Hacking</p>
                                   ...
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>AI Threat Detection Systems</p>
                                      ...
                                      <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Incident Response & Risk Management</p>
                                   ...
                                   <p className='md:text-[16px] text-[13px] font-[380] ml-8'>Wireshark, Kali Linux, Metasploit, ChatGPT for Threat Analysis</p>
                                  </div>
                                ...
                                <div className='flex flex-col gap-3'>
                                        ...
                                        <p className='font-[390] md:text-[16px] text-[13px]'>Work on live simulations and real-world hacking labs to test your skills.</p>
                                  </div>
                            </div>
                        </div>
                        {/* Right Side */}
                        <div className='md:max-w-[600px]'>
                            <img src={aiai} alt='image' className='w-full md:h-105 h-70 object-cover rounded-lg border-5 border-white' />
                        </div>
                    </div>
                </div>
          </section>
          ...
          {/* What You'll Learn */}
          <section className='md:mt-10 mt-15 font-poppins bg-white'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-0 md:mb-10 mb-5'>
                      <div className='flex flex-col gap-3 items-center justify-center md:max-w-3xl mx-auto text-center mb-12'>
                        ...
                        <p className='font-[395] text-[13px] md:text-[16px] text-[#926470]'>In this immersive 16-week program, you’ll gain the technical mastery and strategic confidence to protect  digital  
                     ...
                     <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2.5'>
                                ...
                                <p className='font-[500] text-[#6C0D11] text-[13px] md:text-[16px]'>Foundations of Cybersecurity</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn about digital threats and how they evolve</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand data protection and encryption principles.</li>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] text-[13px] md:text-[16px]'>Ethical Hacking</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Conduct safe penetration tests.</li>
                               <li className='font-[395] md:text-[15px] text-[13px text-[#926470]'>Simulate real-world attacks ethically.</li>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] text-[13px] md:text-[16px]'>AI & Automation</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Use AI tools for automated vulnerability scans.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Predict and prevent future attacks using ML models</li>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] text-[13px] md:text-[16px]'>Career & Portfolio</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Build a personal cybersecurity lab setup</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Prepare for global certifications like CompTIA Security+ or CEH.</li>
          ...
          {/* Why choose Zeplus */}
          <section className='md:max-w-7xl mx-auto md:px-0 px-6 pt-10 md:pt-10 mb-10 font-poppins'>
                    <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        ...
                        {/* why choose */}
                        {/* NEW AI section */}
                <div className=' font-poppins bg-[#8F2436] md:rounded-2xl md:mt-20 mt-10 text-white'>
                 <div className='flex flex-col md:flex-row justify-between md:gap-10 gap-5 py-10 md:py-15 px-10'>
                        {/* Left Side */}
                        
                           <div className='md:max-w-[650px]'>
                             <div className='flex flex-col gap-10'>
                                 <div className='md:max-w-[600px]'>
                                    <h2 className='font-[500] md:text-[35px] text-[20px]'>Advance Your Career with Instructors Who own Recognized Certification</h2>
                                 </div>
...
The instructors were not just teachers — they were mentors who guided me every step of the way. Every project challenged me to think deeper and create smarter. It’s more than a school; it’s a launchpad for anyone serious about a tech career.”</p>
                ...
                {/* 2nd */}
                <div className='bg-white rounded-lg shadow'>
                    <div className='flex flex-col gap-5 p-6 md:p-10.5'>
                        <div className='flex flex-row gap-5 items-center '>
     ...
     <section className='md:max-w-7xl mx-auto mt-10 font-poppins' >
                            ...
                            <div className='bg-[#8F2436] '>
                                 <div className='bg-[#F6F7FD] mt-2'>
                                      <div className='py-4 px-6 '>
                                            <div className='border-b border-[#301D20] pb-10'>
      ...
      {/* Location Section */}
        ...
        <div className='md:p-20 p-6'>
            <div className='flex flex-col gap-1 md:items-center mb-4'>
             ...
             <div className='flex md:flex-row flex-col gap-10 md:items-center'>
                ...
                {/* right side */}
                <div className='md:max-w-[400px] flex md:items-center'>
                    <div className=''>
       ...
       <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-[#F6F7FD] rounded-lg'>
            <div className='md:max-w-4xl mx-auto md:px-0 py-15 md:py-20 px-6 flex flex-col gap-5 items-center'>
                ...
                <p className='font-[400] text-[13px] md:text-[16px] [font-family:Playfair_Display,serif] text-[#301D20]'>Become a certified cybersecurity professional with AI 
                    skills — and help build a safer digital Africa.</p>
                    <div className='flex flex-row gap-5'>
                        <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='text-white bg-[#8F2436] md:py-3 p-2.5 md:px-10 px-7 md:text-[15px] text-[13px] rounded-xl font-poppins'>Apply Now</h2>
                    </div>
                    <a href="https://wa.me/2348169669110?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20Cybersecurity%20course%20at%20Zeplus%20Academy."
                                         target="_blank" rel="noopener noreferrer">
                        <div className='flex flex-row gap-2.5 items-center justify-center cursor-pointer bg-[#27D366] md:px-15 px-5 py-2.5 rounded'>
         ...
         {/*input form section */}
             ...
             <section ref={formRef} className='md:max-w-6xl mx-auto font-poppins md:my-20 my-10 '>
             <div className='bg-[#8F2436] md:rounded-2xl text-white'>
                     <div className='flex flex-col md:items-center justify-center py-10 md:py-15 md:px-0 px-5 '>
                             <div className='md:max-w-[700px] md:text-center px-5 md:mb-10 mb-4'>
             ...
             {/* form */}
             <div className='md:max-w-[550px] mx-auto md:mt-20 mt-10 font-poppins md:px-0 px-10'>
                     <div className='md:max-w-[450px] mx-auto text-center md:px-0 px-5'>
                            <h2 className='md:text-2xl text-[20px] font-[500] text-[#301D20]'>Fill out the form to receive the full program</h2>
                     </div>
                     {/* Form fields */}
                     <form onSubmit={handleSubmit} className='flex flex-col md:gap-5 gap-5 mt-10 md:mb-20 mb-10  md:max-w-[500px] mx-auto'>
                      <input type='hidden' name='course' value='Introduction Cybersecurity' />
                        ...
                        <button type='submit' className='bg-[#ee5b2a] text-white py-2.5  font-[380] rounded-md md:mb-20 mb-10 w-40 md:text-[15px] text-[14px]'>Submit</button>
                     </form>
             </div>
        </section>
         ...
         {/* Best Instructors */}
          <section className='md:max-w-6xl mx-auto mt-10 mb-20 bg-[#8F2436] md:rounded-3xl font-poppins' >
                ...
                <div className='bg-[#8F2436] p-10 md:p-20 rounded-2xl mt-5'>
                  <div className='flex md:flex-row flex-col md:gap-10 gap-5 items-center justify-center'>
                    <div className='flex-1 md:pr-5 md:border-r md:border-white'>
                      <h3 className='text-[13px] md:text-[15px] text-white text-center'>Send us a message at info@zeplusacademy.com 
