...
import introaiheropic from '../assets/images/couses12.png'
import introaiai from '../assets/images/introaiai.png'
...
const Introai = () => {
    ...
    const handleSubmit = (e: any) => {
      ...
      saveSubmission('Introai', payload)
      form.reset()
    }
  ...
  return (
    <section className='w-full bg-white'>
              ...
              <div className='flex flex-col md:flex-row gap-10 items-center justify-between md:px-40 px-6 my-'>
                    ...
                    <div className='flex flex-col md:max-w-[800px]'>
                        <div className='md:max-w-[550px] '>
                            <h1 className='md:text-[50px] text-[26px] font-[700] text-[#301D20] [font-family:Playfair_Display,serif] leading-tight md:leading-[1.05] tracking-tight md:max-w-[550px] max-w-full break-words text-left'>Introduction to Artificial Intelligence</h1>
                        </div>
                        <div className='md:max-w-[700px] flex flex-col gap-3 mt-5'>
                                 <h2 className='md:text-[50px] text-3xl font-[650] text-[#6c0c11]'>250,000 NGN  </h2>
                                  <p className='font-[500] md:text-[16px] text-[14px] text-[#301D20]'>Step into the Future of Intelligence.</p>
                                  <div className='md:max-w-[600px] '>
                                    <p className='font-[390] md:text-[16px] text-[14px] text-[#7F676B]'>Discover how Artificial Intelligence is reshaping the world — and learn how to harness its power to think smarter, work faster, and create meaningful change.</p>
                                  </div>
                    ...
                    {/* Right side */}
                    <div className='md:max-w-[600px] '>
                        <img src={introaiheropic} alt="Digital Growth" className='md:w-full md:h-115 h-70 w-auto object-cover rounded-lg' />
                    </div>
              </div>
        </div>
      </section>
      ...
      <section className='bg-white w-full font-poppins'>
          {/* Course Overview */}
          <section className='w-full bg-[#F9F6F0] py-10 md:py-20 font-poppins px-6 md:px-0'>
            <div className='flex flex-col gap-5 md:max-w-5xl mx-auto'>
                <h2 className='md:text-[50px] text-[25px] font-[650] md:text-center text-[#301D20] [font-family:Playfair_Display,serif]'>Begin Your AI Journey with Confidence</h2>
                <p className='md:text-[15px] text-[13px] font-[395] text-[#301D20]'>Artificial Intelligence is everywhere — from the way we search online to how we communicate, create, and solve problems.</p>
                <p className='md:text-[15px] text-[13px] font-[395] text-[#301D20]'>This beginner-friendly course is designed for students, professionals, and creatives who want to understand what AI is, how it works, and how to use it responsibly.</p>
                <div className='md:px-10  flex flex-col gap-1 mt-2'>
                    <p>By the end of this program, you’ll gain the skills, confidence, and curiosity to explore deeper AI fields such as:</p>
                    <li className='md:text-[15px] text-[13px] font-[395] text-[#301D20]'>Machine Learning</li>
                    <li className='md:text-[15px] text-[13px] font-[395] text-[#301D20]'>Data Science</li>
                    <li className='md:text-[15px] text-[13px] font-[395] text-[#301D20]'>Automation</li>
                </div>
                <h2 className='md:text-[30px] text-[25px] font-[650] md:text-center'>Become AI-Aware and Future-Ready in Just 12 Weeks</h2>
                <p className='md:text-[15px] text-[13px] font-[395] md:text-center'>Start your journey into the world of intelligent systems — one concept, one project at a time.</p>
            </div>
          </section>

          {/* Career Opportunities */}
          <section className='mt-10 bg-[#8F2436] text-white font-poppins'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-15 md:py-25'>
                    <div className='flex md:flex-row flex-col gap-10'>
                        {/* Left Side */}
                        <div className='md:max-w-[650px]'>
                            <div className='flex flex-col gap-5'>
                                <h2 className='md:text-[40px] text-[20px] font-[550] md:max-w-[500px]'>Unlock the Power of Artificial Intelligence</h2>
                                <div className='flex md:flex-row flex-col gap-3 '>
                                 <p className='font-[400] md:text-[16px] text-[14px]'>AI is not just for programmers — it’s for thinkers, innovators, and problem-solvers.</p>
                                 <p className='font-[400] md:text-[16px] text-[14px]'>In this hands-on course, you’ll explore how AI makes decisions, recognizes patterns, and enhances human creativity. You’ll also learn to use AI tools to simplify real-life tasks like writing, analysis, design, and automation.</p>
                                </div>
                                <p className='font-[425] md:text-[16px] text-[14px]'>Tools You’ll Explore:</p>
                                ...
                                <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>ChatGPT </p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>Conversational AI for writing,ideas, and learning</p>
                                   </div>
                                   {/* 2nd */}
                                   <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Google Gemini</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>Smarter research and workflow optimization</p>
                                   </div>
                                   {/* 3rd */}
                                   <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Midjourney / DALL-E:</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>Visual creativity through AI-generated art</p>
                                   </div>
                                      {/* 4th */}
                                      <div className='flex flex-col gap-1'>
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Notion AI & Copilot:</p>
                                       
                                   </div>
                                    <p className='font-[390] ml-8 md:text-[16px] text-[13px]'>Boost productivity through automation</p>
                                   </div>
                                ...
                                <div className='flex flex-col gap-3'>
                                    <p className='font-[390] md:text-[16px] text-[13px]'>No coding experience needed — just curiosity and a willingness to learn.</p>
                        ...
                        {/* Right Side */}
                        <div className='md:max-w-[600px]'>
                            <img src={introaiai} alt='image' className='w-full md:h-105 h-70 object-cover rounded-lg border-5 border-white md:mt-25' />
                        </div>
                    </div>
                </div>
          </section>
          ...
          <section className='md:mt-15 mt-10 font-poppins bg-white'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-0 mb-10'>
                      <div className='flex flex-col gap-3 items-center justify-center md:max-w-3xl mx-auto text-center mb-12'>
                        <h2 className='md:text-[40px] text-[25px] font-[700] text-[#301D20] [font-family:Playfair_Display,serif]'>What You'll Learn</h2>
                        <p className='font-[395] md:text-[16px] text-[14px] text-[#926470]'>In this beginner’s 12-week journey, you’ll build a strong foundation in AI concepts and how they shape our digital future.</p>
                      </div>
                     ...
                     <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2.5'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Foundations of Artificial Intelligence</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand what AI is, how it works, and why it matters</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Explore the history and key breakthroughs that led to today’s AI revolution.</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn about machine learning, neural networks, and natural language processing in simple terms.</li>
                            </div>
                        </div>
                        {/* 2nd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Practical AI Applications</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]' >Discover how AI is used across industries — business, healthcare, design, marketing, and more</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Use real AI tools to solve practical everyday problems</li>
                               <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand the role of data in making AI smarter.</li>
                            </div>
                        </div>
                        {/* 3rd */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Ethics and the Future of AI</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Learn how to use AI responsibly and avoid bias in automation.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Understand how AI impacts jobs, creativity, and decision-making.</li>
                                 <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Discuss the future of work and the rise of human-AI collaboration.</li>
                            </div>
                        </div>
                        {/* 4th */}
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11] md:text-[15px] text-[14px]'>Hands-On Mini Projects</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Build simple AI-driven tasks and experiments guided by mentors.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Use prompt engineering to get smarter, more accurate results from AI tools.</li>
                                <li className='font-[395] md:text-[15px] text-[13px] text-[#926470]'>Present a mini capstone project that demonstrates your understanding.</li>
                            </div>
                        </div>
          ...
          {/* Why choose Zeplus */}
          <section className='md:max-w-6xl mx-auto md:px-0 px-6 pt-5 md:pt-10 mb-10 font-poppins'>
                    <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='bg-[#EFE1DD] text-[#942E3F] md:py-3 py-2.5 md:px-14 px-5 rounded font-poppins md:text-[15px] text-[14px]'>Brochure</h2>
                    </div>

                        {/* why choose */}
                        <div className='bg-[#8F2436] text-white font-poppins mt-10  rounded-lg'>
                            <div className='md:py-20 py-10 md:px-0 px-6'>
                              <div className='flex flex-col gap-1  md:max-w-4xl mx-auto'>
                                      <h2 className='md:text-[40px] text-[20px] font-[700] md:items-center md:justify-center md:text-center'>Why Choose Zeplus Academy?</h2>
                                     <p className='font-[390] md:text-[16px] text-[13px] md:items-center md:justify-center md:text-center'>At Zeplus Academy, we don’t just teach tools — we empower professionals to lead change.</p>
                    ...
                    {/* 2nd */}
                     <div className='flex flex-row gap-3 items-center'>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Beginner-Friendly Learning<span className='font-[395]'>Start from zero, grow with guidance.</span></p>
                    </div>
                    {/* 3rd */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Hands-On Mentorship:<span className='font-[395]'>Learn directly from industry experts.</span></p>
                    </div>
                    {/* 4th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>Project-Based Curriculum:<span className='font-[395]'> Apply what you learn in real scenarios</span></p>
                    </div>
                    {/* 5th */}
                      <div className='flex flex-row gap-3 items-center'>
                        <span>
                        ...
                        <p className='md:text-[15px] text-[13px] font-[430]'>AI-Powered Education:<span className='font-[395]'> Modern learning designed for the age of automation.</span></p>
                    </div>
                </div>
...
Zeplus Academy for Data Analytics</h2>
           ...
           <div className='grid md:grid-cols-3 grid-cols-1 gap-6 items-center justify-center'>
                ...
                {/* 2nd */}
                <div className='bg-white rounded-lg shadow'>
                    <div className='flex flex-col gap-5 px-10 py-10.5'>
                        <div className='flex flex-row gap-5 items-center '>
     ...
     <section className='md:max-w-7xl mx-auto mt-10 font-poppins' >
               <div className='flex flex-col items-center gap-5 justify-center mb-10 md:px-0 px-5'>
                ...
                <div className='grid md:grid-cols-3 grid-cols-1 gap-10 my-10 md:px-0 px-10'>
                                 ...
                                 <div className='bg-[#F6F7FD] mt-2'>
                                      <div className='py-4 px-6 '>
                                            <div className='border-b border-gray-300  pb-10'>
                                                <h2 className='text-[25px] font-[550] text-[#301D20] '>Tuesday 2026</h2>
                                            </div>
                      ...
                      <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='ttext-[#942E3F] bg-[#EFE1DD] md:py-3 py-2.5 md:px-10 px-5 rounded-full font-poppins md:text-[15px] text-[14px]'>Enroll Now</h2>
                    </div>
               </div>
     </section>
      ...
      <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-[#8F2436] text-white md:rounded-lg'>
        <div className='md:p-15  p-6 md:py-20 md:px-10'>
         ...
         {/*input form section */}
             ...
             <section ref={formRef} className='md:max-w-7xl mx-auto md:mt-20 mt-10 md:px-0 px-8 font-poppins'>
                     <div className=' text-center'>
                            <h2 className='md:text-2xl text-[20px] font-[500] text-[#958184]'>Fill out the form below to receive the program that you're interested in.</h2>
                     </div>
                     {/* Form fields */}
                     <form onSubmit={handleSubmit} className='flex flex-col md:gap-5 gap-5 mt-10 md:mb-20 mb-10  md:max-w-[500px] mx-auto'>
                      <input type='hidden' name='course' value='Introduction to Artificial Intelligence' />
                         ...
                         <div className='flex flex-col gap-2'>
                            ...
                            <select name='source' className='border border-gray-300 p-2 text-[#958184] rounded-md text-sm font-[380] focus:outline-none focus:ring focus:ring-gray-300'>
                         ...
                         <div className='flex flex-col gap-2'>
                            ...
                            <select name='hybrid' className='border border-gray-300 p-2 text-[#958184] rounded-md text-sm font-[380] focus:outline-none focus:ring focus:ring-gray-300'>
                                <option value=''>Select an option</option>
                                <option value='In-Person'>In-Person</option>
                                <option value='Online'>Online</option>                                 
                            </select>
                        </div>
                        <button type='submit' className='bg-[#958184] text-white py-2.5  font-[380] rounded-md md:mb-20 mb-10 w-40 md:text-[15px] text-[14px]'>Submit</button>
                     </form>
             </section>
         ...
         {/* Best Instructors */}
          <section className='md:max-w-6xl mx-auto mt-10 md:mb-20 mb-10 bg-[#8F2436] md:rounded-2xl font-poppins' >
            <div className='flex flex-col md:flex-row gap-10 md:gap-5 p-10 md:p-20'>
                {/* left side */}
                <div className='md:max-w-[600px]'>
                  <div className='flex flex-col gap-5 '>
