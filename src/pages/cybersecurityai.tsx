...
import ethaihero from '../assets/images/ethai.png'
import ethai from '../assets/images/aipowereth.png'
  ...
  return (
    <section className='w-full bg-white'>
              ...
              <div className='flex flex-col md:flex-row gap-10 items-center justify-between md:px-40 px-6 my-'>
                    ...
                    <div className='flex flex-col md:max-w-[800px]'>
                        <div className='md:max-w-[800px] '>
                            <h1 className='md:text-[50px] text-[26px] font-[700] text-[#301D20] [font-family:Playfair_Display,serif] leading-tight md:leading-[1.05] tracking-tight md:max-w-[600px] max-w-full break-words text-left '>Cybersecurity & Ethical Hacking Course with AI Tools</h1>
                        </div>
                        <div className='md:max-w-[700px] flex flex-col gap-3 mt-5'>
                                 ...
                                 <div className='flex flex-row gap-4'>
                                    <p className='font-[405] text-[14px] md:text-[16px] text-[#7F676B]'>Protect the Future</p>
                                     <p className='font-[405] text-[14px] md:text-[16px] text-[#7F676B]'>Defend the Digital World.</p>
                                    
                                 </div>
                                  <div className='md:max-w-[600px] '>
                                    <p className='font-[395] md:text-[16px] text-[14px] text-[#7F676B]'>Gain the skills to secure systems, prevent cyber threats, and lead Africa’s next generation of ethical hackers — powered by AI intelligence</p>
                                  </div>
                    ...
                    {/* Right side */}
                    <div className='md:max-w-[600px] '>
                        <img src={ethaihero} alt="Digital Growth" className='w-full md:h-115 h-70 object-cover rounded-lg' />
                    </div>
              </div>
        </div>
      </section>
      ...
      <section className='bg-white w-full font-poppins'>
          {/* Course Overview */}
          <div className=' bg-[#8F2436] md:max-w-[1350px] mx-auto md:my-15 my-10 md:rounded-2xl '>
             <div className='md:max-w-4xl mx-auto md:px-0 px-6 py-10 md:py-15'>
                <div className='flex flex-col md:gap-8 gap-3 items-center justify-center'>
                <h2 className='md:text-[40px] font-[600] text-[22px] md:text-center text-[#ffffff] [font-family:Playfair_Display,serif]'>Master Cyber Defense in 16 Weeks</h2>
                <div className='flex flex-col gap-3 items-center '>
                    <p className='md:text-[16px] text-[13px] md:text-center  text-[#ffffff]'>Learn how to identify vulnerabilities, protect networks, and detect attacks before they happen.</p>
                     <p className='md:text-[16px] text-[13px] md:text-center  text-[#ffffff]'>Our AI-powered cybersecurity course combines hands-on labs with expert mentorship to prepare you for the real world.</p>
                </div>
             </div>
             </div>
          </div>
          ...
          <section className='mt-10 bg-[#8F2436] text-white font-poppins md:rounded-2xl md:max-w-[1350px] mx-auto'>
                <div className='md:max-w-7xl mx-auto md:px-10 px-6 py-15 md:py-15'>
                    <div className='flex md:flex-row flex-col gap-10 items-center'>
                        {/* Left Side */}
                        <div className='md:max-w-[650px]'>
                            <div className='flex flex-col md:gap-5 gap-3'>
                                <h2 className='md:text-[40px] text-[25px] font-[550] [font-family:Playfair_Display,serif]'>AI-Powered Cyber Defense</h2>
                                <p className='md:text-[16px] text-[13px] font-[380]'>Today’s hackers use AI — and so will you.</p>
                                <p className='font-[390]  md:text-[16px] text-[13px]'>Learn how AI strengthens defense systems, predicts threats, and enhances your security analysis.</p>
                                <p className='font-[420]  md:text-[16px] text-[13px]'>You’ll master:</p>
                                <div className='flex flex-col gap-4 mt-3 md:ml-10'>
                                   ...
                                   <div className='flex flex-row gap-4'>
                                        ...
                                        <p className='font-[400] md:text-[16px] text-[13px]'>Tools</p>
                                       
                                   </div>
                                   <p className='font-[400] md:text-[16px] text-[13px] ml-8'>Wireshark, Kali Linux, Metasploit, ChatGPT for Threat Analysis</p>
                                   </div>
                        ...
                        {/* Right Side */}
                        <div className='md:max-w-[600px]'>
                            <img src={ethai} alt='image' className='w-full md:h-105 h-70 object-cover border-5 border-white rounded-lg' />
                        </div>
                    </div>
                </div>
          </section>
          ...
          <section className='md:mt-20 mt-15 font-poppins bg-white'>
                <div className='md:max-w-7xl mx-auto md:px-0 px-6 py-0 md:mb-20 mb-10'>
                      <div className='flex flex-col gap-3 items-center justify-center md:max-w-3xl mx-auto text-center mb-12'>
                        ...
                        <p className='font-[395]  md:text-[16px] text-[13px] text-[#926470]'>In this immersive 16-week program, you’ll gain the technical mastery and strategic confidence to protect  digital  
                     ...
                     <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2.5'>
                                ...
                                <p className='font-[500] text-[#6C0D11]   md:text-[16px] text-[13px]'>Foundations of Cybersecurity</p>
                            </div>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11]  md:text-[16px] text-[13px]'>Ethical Hacking</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                            <div className='flex flex-row gap-2'>
                                ...
                                <p className='font-[500] text-[#6C0D11]   md:text-[16px] text-[13px]'>AI & Automation</p>
                            </div>
                            <div className='flex flex-col gap-2.5 ml-5'>
           ...
           <section className='md:max-w-[1350px] mx-auto font-poppins my-10 px-5'>
            {/* Download Brochure */}
                         <div className='flex items-center justify-center'>
                            <h2 className='text-[#ffffff] bg-[#EE5B2A] md:py-3 py-2.5 md:px-14 px-5 text-[13px] md:text-[16px] rounded-full font-poppins'>Brochure</h2>

                         </div>

                         {/* Full-Stack Developer Library */}
                        <div className='bg-[#8F2436] p-15 mt-10 text-white md:rounded-2xl '>
                            <div className='flex flex-col gap-3 items-center'>
                                <h2 className='md:text-[50px] text-[20px] font-[600] [font-family:Playfair_Display,serif] '>Why Zeplus Academy?</h2>
                                <p className='font-[395] md:text-[16px] text-[13px] text-center'>Because digital freedom starts with security — and Africa needs ethical defenders.</p>
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mt-10'>
                                    {/* 1st */}
                                    <div className='bg-[#9C3C4A] p-10 rounded-xl'>
                                        <p className='text-white md:text-[16px] text-[13px] font-[430]'>Real-Life Hacking Labs</p>
                                    </div>
                                    {/* 2nd */}
                                    <div className='bg-[#9C3C4A] p-10 rounded-xl'>
                                        <p className='text-white md:text-[16px] text-[13px] font-[430]'>Mentorship from Security Experts</p>
                                    </div>
                                    {/* 3rd */}
                                    <div className='bg-[#9C3C4A] p-10 rounded-xl'>
                                        <p className='text-white md:text-[16px] text-[13px] font-[430]'>AI-Powered Defense Training</p>
                                    </div>
                                    {/* 4th */}
                                    <div className='bg-[#9C3C4A] p-10 rounded-xl'>
                                        <p className='text-white md:text-[16px] text-[13px] font-[430]'>Career Launch Program with Global Companies</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Zeplus Academy for Cybersecurity</h2>
            </div>
     ...
     <section className='md:max-w-7xl mx-auto mt-10 font-poppins' >
                ...
                <div className='grid md:grid-cols-3 grid-cols-1 md:gap-10 gap-5 md:my-10 my-5 md:px-0 px-10'>
                            ...
                            <div className='bg-[#EE5B2A] '>
                                 <div className='bg-[#F6F7FD] mt-2'>
                                      <div className='py-4 px-6 '>
                                            <div className='border-b border-gray-300  pb-10'>
                                                <h2 className='text-[25px] font-[550] '>March 2026</h2>
                                            </div>
                                            <div className='flex flex-col gap-5 my-5'>
                                                  <div className='flex flex-row gap-2 items-center'>
                                                      <span>
                      ...
                      <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='text-white bg-[#EE5B2A] md:py-3 py-2.5 md:text-[15px] text-[13px] md:px-10 px-5 rounded-xl font-poppins'>Enroll Now</h2>
                    </div>
               </div>
     </section>
            ...
            <div className='flex flex-col gap-1 md:items-center mb-4'>
             ...
             <div className='flex md:flex-row flex-col gap-10 md:items-center'>
                ...
                <div className='md:max-w-[650px] md:border-r border-white ssm:border-b md:pr-6 md:pb-6'>
                   <h2 className='md:text-[15px] text-[13px] font-[395]'><span className='font-[420]'>In-Person:</span> Zeplus Academy space in Magodo, 6E Adekunle Banjo Avenue Magodo Phase 2</h2>
                </div>
                {/* right side */}
       ...
       <section className='md:max-w-6xl mx-auto mt-10 font-poppins bg-[#F6F7FD] rounded-lg'>
            <div className='md:max-w-4xl mx-auto md:px-0 py-15 md:py-25 px-6 flex flex-col gap-5 items-center'>
                <h2 className='font-[600] md:text-[45px] text-[25px] text-[#301D20]'>Ready to Defend the Future?</h2>
                <p className='font-[400] text-[13px] md:text-[16px] text-[#958184]'>Become a certified cybersecurity professional with AI 
                    skills — and help build a safer digital Africa.</p>
                    <div className='flex flex-row gap-5'>
                        <div onClick={scrollToForm} role="button" tabIndex={0} className='flex items-center justify-center cursor-pointer w-max mx-auto'>
                        <h2 className='text-white bg-[#EE5B2A] md:py-3 py-2.5 md:px-15 px-7 rounded-xl font-poppins md:text-[15px] text-[13px]'>Apply Now</h2>
                    </div>
                    <a href="https://wa.me/2348169669110?text=Hello%2C%20I%20would%20like%20to%20learn%20more%20about%20the%20Full%20Stack%20Web%20Development%20with%20AI%20Integration%20course%20at%20Zeplus%20Academy."
                                         target="_blank"
                                            rel="noopener noreferrer">
                        <div className='flex flex-row gap-2.5 items-center justify-center cursor-pointer bg-[#27D366] md:px-15 px-5 py-2.5 rounded-xl'>
         ...
         {/*input form section */}
             ...
             <div className='md:max-w-[550px] mx-auto md:mt-20 mt-10 font-poppins '>
                     <div className='md:max-w-[450px] mx-auto text-center md:px-0 px-5'>
                            <h2 className='text-2xl font-[500] text-[#958184]'>Fill out the form to receive the full program</h2>
                     </div>
                     {/* Form fields */}
                                 <form onSubmit={(e) => {
                                    e.preventDefault()
                                    ...
                                    const payload: any = Object.fromEntries(fd.entries())
                                                            // enforce implicit course for this page
                                      payload.course = 'Cybersecurity & AI'
                                         try { saveSubmission('cybersecurityai', payload) } catch (err) {}
                        ...
                        {/* Course is implicit for this page (Cybersecurity & AI) */}
                        <input type='hidden' name='course' value='Cybersecurity & AI' />

                         <div className='flex flex-col gap-2 text-[#958184]'>
                         ...
                         <button type='submit' className='bg-[#EE5B2A] text-white py-2.5  font-[380] rounded-md mb-20'>Submit</button>
                     </form>
             </div>
        </section>
         ...
         {/* Best Instructors */}
          <section className='md:max-w-6xl mx-auto mt-10 mb-10 md:mb-20 bg-[#8F2436] md:rounded-2xl font-poppins' >
            <div className='flex flex-col md:flex-row gap-10 md:gap-5 md:p-20 p-10'>
                {/* left side */}
                <div className='md:max-w-[600px]'>
                  <div className='flex flex-col gap-5 '>
